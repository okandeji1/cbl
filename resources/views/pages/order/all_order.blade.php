                                            ...
                                            <tbody>
                                                @foreach ($orders as $key => $order)
                                                    <tr>
                                                        ...
                                                        <td>{{ $order->lab->fullname }}</td>
                                                        <td>
                                                            @switch($order->status)
                                                                @case('PENDING')
                                                                <div class="badge badge-secondary badge-shadow">{{ $order->status }}
                                                                </div>
                                                                @break
                                                                @case('PICKED-UP')
                                                                <div class="badge badge-warning badge-shadow">{{ $order->status }}
                                                                </div>
                                                                @break
                                                                @case('IN-TRANSIT')
                                                                <div class="badge badge-warning badge-shadow">{{ $order->status }}
                                                                ...
                                                                @break
                                                                @case('CANCELLED')
                                                                <div class="badge badge-danger badge-shadow">{{ $order->status }}
                                                                </div>
                                                                @break
                                                                @case('DELIVERED')
                                                                <div class="badge badge-success badge-shadow">{{ $order->status }}
                                                                </div>
                                                                @break
                                                                @default
                                                        ...
                                                        @else
                                                            <td>
                                                                @switch($order->status)
                                                                    ...
                                                                    @break
                                                                    @default
                                                                    <div class="badge badge-danger badge-shadow">Not approved yet
                                                                    </div>
                                                                @endswitch
                                                            </td>
                                                        @endif
