                                        ...
                                        <div class="row">
                                            <div class="form-group form-float col-6">
                                                <div class="form-line">
                                                    ...
                                                    <input list="regions" id="region" name="region"
                                                        ...
                                                        form.errors.has('region') }" placeholder="Select Region" required>
                                                    <datalist id="regions">
                                            ...
                                            <div class="form-group form-float col-12">
                                                <div class="form-line">
                                                    ...
                                                    <input list="admins" name="admin" class="form-control :class="
                                                        { 'is-invalid' : form.errors.has('admin') }" id="admin"
                                                        placeholder="Select an admin for this lab" required>
                                                    <datalist id="admins">
                                                        @if (count($admins) > 0)
